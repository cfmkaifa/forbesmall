...
public class ExcelView extends AbstractView {
    ...
    static {
        ...
        try {
            File mallPropertiesFile = ResourceUtils.getFile(CommonAttributes.MALL_PROPERTIES_PATH);
            properties = PropertiesLoaderUtils.loadProperties(new FileSystemResource(mallPropertiesFile));
        } catch (IOException e) {
