...
public class JavaToPdfHtmlFreeMarker {
	 private static final String DEST = "target/HelloWorld_CN_HTML_FREEMARKER_FS.pdf";
	    ...
	    private static final String LOGO_PATH = "file://C:/opt/forbesupload/upload/image/201912/cc2860ac-94c4-43f3-8c8d-33c1cd2b7313.jpg";
	    ...
	    static {
	        ...
	        //freemarker的模板目录
	        try {
	            freemarkerCfg.setDirectoryForTemplateLoading(new File("C:/opt/pdfPath/"));
	        } catch (IOException e) {
	            e.printStackTrace();
	        }
	    }
