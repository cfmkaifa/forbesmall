...
public abstract class User extends BaseEntity<Long> {
     ...
     * 设置用户1的消息组
     *
     * @param user1MessageGroups 用户1的消息组
     */
     ...
     * 设置用户2的消息组
     *
     * @param user2MessageGroups 用户2的消息组
     */
