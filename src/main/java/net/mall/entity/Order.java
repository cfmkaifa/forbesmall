...
public class Order extends BaseEntity<Long> {
     ...
     * 设置支付方式类型
     *
     * @param paymentMethodType 支付方式类型
     */
     ...
     * 设置分销佣金
     *
     * @param distributionCommissions 分销佣金
     */
     ...
     * 获取结算金额
     *
     * @param grantedDistributionCommissionTotals 已发放分销佣金总计
     * @return 结算金额
     */
    @Transient
