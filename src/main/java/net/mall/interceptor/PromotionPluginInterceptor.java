...
public class PromotionPluginInterceptor extends HandlerInterceptorAdapter {
     ...
     * 设置促销插件Provider
     *
     * @param promotionPluginProvider 促销插件Provider
     */
     ...
     * 设置"促销插件ID"参数名称
     *
     * @param promotionPluginIdParameterName "促销插件ID"参数名称
     */
    ...
    public static class PromotionIdPromotionPluginProvider implements PromotionPluginProvider {
         ...
         * 设置"促销ID"参数名称
         *
         * @param promotionIdParameterName "促销ID"参数名称
         */
