...
public class AreaFreightConfigController extends BaseController {
    ...
    public @ResponseBody
    boolean checkArea(Long id, @ModelAttribute(binding = false) ShippingMethod shippingMethod, @ModelAttribute(binding = false) Area area, @CurrentStore Store currentStore) {
