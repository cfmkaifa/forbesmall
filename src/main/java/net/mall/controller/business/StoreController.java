...
public class StoreController extends BaseController {
    ...
    public @ResponseBody
    boolean checkName(String name, Store store) {
    ...
    public @ResponseBody
    Map<String, Object> storeStatus(@CurrentStore Store currentStore) {
    ...
    @GetMapping("/end_date")
    public @ResponseBody
    Map<String, Object> endDate(@CurrentStore Store currentStore) {
        Map<String, Object> data = new HashMap<>();
