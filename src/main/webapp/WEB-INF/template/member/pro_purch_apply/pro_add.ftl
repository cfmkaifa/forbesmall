            ...
            <script>
                $().ready(function() {
                    ...
                    $productImageFile.fileinput({
                        uploadUrl: "${base}/member/product/upload_product_image",
                    ...
                    function loadParameter() {
                        $.ajax({
                            url: "${base}/member/product/parameters",
                            type: "GET",
                            data: {
                    ...
                    function loadAttribute() {
                        $.ajax({
                            url: "${base}/member/product/attributes",
                            type: "GET",
                            data: {
                                productCategoryId: $productCategoryId.val()
                            },
                    ...
                    function loadSpecification() {
                        $.ajax({
                            url: "${base}/member/product/specifications",
                            type: "GET",
                            data: {
                                productCategoryId: $productCategoryId.val()
                            },
                    ...
                    $productForm.validate({
                        rules: {
                            ...
                            sn: {
                                pattern: /^[0-9a-zA-Z_-]+$/,
                                remote: {
                                    url: "${base}/member/product/check_sn",
                                    cache: false
                                }
                            },
                            name: "required",
                        ...
                        submitHandler: function(form) {
                            ...
                            $(form).ajaxSubmit({
                                successRedirectUrl: "${base}/member/product/list"
                            });
                        }
                    });
                });
...
<main>
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-10">
                <form id="productForm" class="form-horizontal" action="${base}/member/product/save" method="post">
