...
<head>
	...
	<title>${message("business.product.list")} - Powered By </title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form action="${base}/business/sample/list" method="get">
									...
									<tbody>
										[#list page.content as product]
											<tr>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/business/sample/edit?productId=${product.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
