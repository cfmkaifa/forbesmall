						...
						submitHandler: function(form) {
							$(form).ajaxSubmit({
								...
								successRedirectUrl: function(redirectUrlParameterName) {
									console.log(redirectUrlParameterName);
									debugger;
			...
			<div class="col-xs-4">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form id="loginForm" name="loginForm" action="${base}/business/login" method="post">
							<div class="passwords-login">
								...
								<div class="form-group">
									<button class="btn btn-primary btn-lg btn-block" type="submit" id="passworkButton">
										[#if socialUserId?has_content && uniqueId?has_content]${message("business.login.bind")}[#else]${message("business.login.submit")}[/#if]
									</button>
								</div>
							</div>
						</form>
						[#--手机验证--]
						<form id="phoneForm" name="phoneForm" action="${base}/business/login" method="post">
...
[#--										<input id="csrfToken" name="csrfToken" type="hidden">--]
										...
										<input id="phone" name="username" class="form-control" type="text" maxlength="200" placeholder="${message("business.login.iPhone")}" autocomplete="off" style="width: 62%;border: none;border-left: 1px solid #d8d8d8;">
								...
								<div class="form-group">
									<div class="input-group">
										...
										<input id="verification" name="password" class="form-control" type="text" maxlength="200" placeholder="${message("business.login.verification")}" autocomplete="off">
									</div>
								</div>
								<div class="form-group">
