            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label item-required" for="title">${message("Ad.title")}
                            :</label>
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label item-required">${message("Ad.adPosition")}
                            :</label>
                        <div class="col-xs-9 col-sm-4">
                            <select name="adPositionId" class="selectpicker form-control" data-size="10">
                                [#list adPositions as adPosition]
                                    <option value="${adPosition.id}"[#if adPosition == ad.adPosition] selected[/#if]>${adPosition.name}
                                        [${adPosition.width} × ${adPosition.height}]
                                    </option>
                                [/#list]
                            </select>
                        </div>
                    ...
                    <div class="[#if ad.type != "TEXT"]hidden-element[/#if] form-group">
                        ...
                        <div class="col-xs-9 col-sm-10">
                            <textarea id="content" name="content" class="form-control"
                                      data-provide="editor">${ad.content}</textarea>
                        </div>
                    </div>
                    <div class="[#if ad.type == "TEXT"]hidden-element[/#if] form-group">
                        <label class="col-xs-3 col-sm-2 control-label item-required">${message("Ad.path")}:</label>
                        <div class="col-xs-9 col-sm-4">
                            <input id="path" name="path" type="hidden" value="${ad.path}" data-provide="fileinput"
                                   data-file-type="IMAGE"[#if ad.type == "TEXT"] disabled[/#if]>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label" for="beginDate">${message("common.dateRange")}
                            :</label>
                        <div class="col-xs-9 col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <input id="url" name="url" class="form-control" type="text" value="${ad.url}"
                                   maxlength="200">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <input id="order" name="order" class="form-control" type="text" value="${ad.order}"
                                   maxlength="9">
                        </div>
                    </div>
                </div>
