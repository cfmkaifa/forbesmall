...
<head>
	...
	<title>${message("admin.plugin.pay99billBankPayment.setting")} - Powered By </title>
...
<body>
	...
	<main>
		<div class="container-fluid">
			...
			<form id="pay99billBankPaymentForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/pay_99bill_bank_payment/update/${supplierId}" method="post">
