	...
	<div id="mainSidebarPanelGroup" class="panel-group">
		...
		<div class="panel panel-default">
			[@has_any_permissions_tag permissions = ["admin:member", "admin:memberRank", "admin:memberAttribute", "admin:point", "admin:memberDeposit", "admin:review", "admin:consultation", "admin:messageConfig"]]
				...
				[/#if]
			[/@has_any_permissions_tag]
			<div id="memberGroupPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("admin/member/.*|admin/member_rank/.*|admin/member_attribute/.*|admin/point/.*|admin/member_deposit/.*|admin/review/.*|admin/consultation/.*|admin/message_config/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
