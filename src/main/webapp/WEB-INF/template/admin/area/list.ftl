    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-default" href="${base}/admin/area/add[#if parent??]?parentId=${parent.id}[/#if]"
                       data-redirect-url[#if !parent??]="${base}/admin/area/list"[/#if]>
                    ...
                    <table class="table table-hover">
                        ...
                        [#list areas?chunk(5) as row]
                            <tr>
                                [#list row as area]
                                    <td>
                                        <a href="${base}/admin/area/list?parentId=${area.id}"
                                           title="${message("common.view")}" data-toggle="tooltip">${area.name}</a>
                                        <a class="btn btn-default btn-xs btn-icon"
                                           href="${base}/admin/area/edit?id=${area.id}"
                                           title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
                                            <i class="iconfont icon-write"></i>
                                        </a>
                                        <a class="delete btn btn-default btn-xs btn-icon" href="javascript:;"
                                           title="${message("common.delete")}" data-toggle="tooltip"
                                           data-id="${area.id}">
                        ...
                        [#if !areas?has_content]
                            <tr>
                                <td class="text-center" colspan="5">
                                    ...
                                    <a href="${base}/admin/area/add[#if parent??]?parentId=${parent.id}[/#if]"
                                       data-redirect-url>${message("common.add")}</a>
                                </td>
                            </tr>
                        [/#if]
                    </table>
