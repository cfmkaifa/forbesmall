		...
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				$productFileConfirm.click(function() {
					...
					$.ajax({
						url: "${base}/admin/product/import-product",
						type: "POST",
						data: {
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row" style="display: flex;">
							<label class="col-xs-3 control-label" style="width: 9%;">${message("StoreProduct.name")}:</label>
							<div class="col-xs-9" style="clear: both;">
								<select name="storeId"  class="selectpicker form-control" data-live-search="true" data-size="5" >
