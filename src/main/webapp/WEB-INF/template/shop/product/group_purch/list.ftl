    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-10">
                ...
                <form id="productForm" action="${base}${(productCategory.path)!"/product/group_purch/list"}"
                      method="get">
                    [#if type??]
                    ...
                    [#if productCategory??]
                        ...
                        [#list filterAttributes as filterAttribute]
                            <input name="attribute_${filterAttribute.id}"
                                   type="hidden"[#if attributeValueMap?keys?seq_contains(filterAttribute)] value="${attributeValueMap.get(filterAttribute)}"[#else] disabled[/#if]>
                        [/#list]
                                                            ...
                                                            <a href="javascript:;" data-brand-id="${filterBrand.id}">
                                                                [#if filterBrand.type == "IMAGE"]
                                                                    <img class="img-responsive center-block"
                                                                         src="${filterBrand.logo}"
                                                                         alt="${filterBrand.name}">
                                                                [/#if]
                                                ...
                                                <ul class="text-filter-group clearfix">
                                                    [#list filterAttribute.options as option]
                                                        <li[#if attributeValueMap.get(filterAttribute) == option] class="active" title="${message("shop.product.cancel")}"[/#if]>
                                                            <a href="javascript:;"
                                                               data-attribute-id="${filterAttribute.id}"
                                                               data-attribute-option="${option}">${option}</a>
                                                        </li>
                                                    [/#list]
                                                </ul>
                                                <a class="filter-group-collapse" href="javascript:;">
                    ...
                    <div class="bar clearfix">
                        ...
                        <div class="bar-item bg-white">
                            ...
                            <input name="endPrice" type="text" value="${endPrice}" maxlength="16"
                                   placeholder="${message("shop.product.endPricePlaceholder")}" onpaste="return false;">
