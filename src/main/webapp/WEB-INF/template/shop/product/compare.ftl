                                ...
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <p class="text-overflow">
                                            <a href="${base}${product.path}" titile="${product.name}"
                                ...
                                [#if product.parameterValues?has_content]
                                    <table class="parameter table table-bordered">
                                        [#list product.parameterValues as parameterValue]
                                            <tr>
                                                <th class="parameter-value-group"
                                                    colspan="2">${parameterValue.group}</th>
                                            </tr>
                                            [#list parameterValue.entries as entry]
                                                <tr data-parameter-value-group="${parameterValue.group}"
                                                    data-parameter-value-entry-name="${entry.name}">
                                                    <th>${entry.name}</th>
                                                    <td>${entry.value}</td>
                                                </tr>
                                            [/#list]
