        ...
        <li>
            ...
            <div class="media">
                ...
                <div class="media-body media-middle">
                    ...
                    <a class="delete-compare btn btn-default btn-xs btn-icon" href="javascript:;"
                       title="${message("common.delete")}" data-product-id="<%-compareProduct.id%>">
        ...
        <form id="compareForm" action="${base}/product/compare" method="get">
            <div id="compareBar" class="compare-bar">
                ...
                <div class="compare-bar-body clearfix">
                    ...
                    <div class="action">
                        <a class="compare btn btn-primary"
                           href="javascript:;">${message("shop.product.beginCompare")}</a>
                ...
                [#if page.content?has_content]
                    <form id="productForm" action="${base}/product/search" method="get">
                        ...
                        <div class="bar clearfix">
                            <a class="bar-item[#if !orderType?? || orderType == "TOP_DESC"] active[/#if]"
                               href="javascript:;" data-order-type="TOP_DESC">
                                ${message("shop.product.topDesc")}
                                <i class="iconfont icon-unfold"></i>
                            </a>
                            <a class="bar-item[#if orderType == "SALES_DESC"] active[/#if]" href="javascript:;"
                               data-order-type="SALES_DESC">
                                ${message("shop.product.salesDesc")}
                                <i class="iconfont icon-unfold"></i>
                            </a>
                            <a class="bar-item[#if orderType == "SCORE_DESC"] active[/#if]" href="javascript:;"
                               data-order-type="SCORE_DESC">
                                ${message("shop.product.scoreDesc")}
                                <i class="iconfont icon-unfold"></i>
                            </a>
                            <a class="bar-item[#if orderType == "PRICE_ASC"] active[/#if]" href="javascript:;"
                               data-order-type="PRICE_ASC">
                            ...
                            <div class="bar-item bg-white">
                                <div class="checkbox checkbox-inline">
                                    <input name="storeType" type="checkbox"
                                           value="SELF"[#if storeType == "SELF"] checked[/#if]>
                                    <label>${message("shop.product.self")}</label>
                                </div>
                                <div class="checkbox checkbox-inline">
                                    <input name="isOutOfStock" type="checkbox"
                                           value="false"[#if isOutOfStock?? && !isOutOfStock] checked[/#if]>
                                    <label>${message("shop.product.inStock")}</label>
                                </div>
                            </div>
                            <div class="bar-item bg-white">
                                <input name="startPrice" type="text" value="${startPrice}" maxlength="16"
                                       placeholder="${message("shop.product.startPricePlaceholder")}"
                                       onpaste="return false;">
                                -
                                <input name="endPrice" type="text" value="${endPrice}" maxlength="16"
                                       placeholder="${message("shop.product.endPricePlaceholder")}"
                                       onpaste="return false;">
                                ...
                                [#list page.content as product]
                                    ...
                                    <li class="list-item">
                                        <div class="list-item-body">
                                            <a href="${base}${product.path}" target="_blank">
                                                <img id="productImage${product.id}"
                                                     class="lazy-load img-responsive center-block"
                                            ...
                                            <p class="text-center">
                                                <a href="${base}${product.store.path}" title="${product.store.name}"
                                        ...
                                        <div class="list-item-footer clearfix">
                                            [#if product.type == "GENERAL"]
                                                <a href="javascript:;" data-action="addCart"
                                                   data-sku-id="${defaultSku.id}" data-cart-target="#mainSidebarCart"
                                                   data-product-image-target="#productImage${product.id}">
                                            ...
                                            [/#if]
                                            <a class="add-product-favorite" href="javascript:;"
                                               title="${message("shop.product.addProductFavorite")}"
                                               data-action="addProductFavorite" data-product-id="${product.id}">
                                                <i class="iconfont icon-like"></i>
                                            </a>
                                            <a class="add-compare" href="javascript:;"
                                               title="${message("shop.product.addCompare")}"
