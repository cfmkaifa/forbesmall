        ...
        <li>
            <a href="${base}<%-product.path%>" target="_blank">
                <img class="img-responsive center-block"
                     src="<%-product.thumbnail != null ? product.thumbnail : "${setting.defaultThumbnailProductImage}
                "%>" alt="<%-product.name%>">
...
<aside id="mainSidebar" class="main-sidebar clearfix">
    <div class="main-sidebar-body">
        <ul>
            ...
            <li>
                <a href="${base}/member/order/list" title="${message("shop.mainSidebar.orderListTitle")}"
                   data-toggle="tooltip" data-placement="left">
                    <i class="iconfont icon-form"></i>
                </a>
            </li>
            <li>
                <a id="historyProductCollapse" href="javascript:;"
                   title="${message("shop.mainSidebar.historyProductTitle")}" data-toggle="tooltip"
                   data-placement="left">
            ...
            <li>
                <a href="${base}/member/product_favorite/list"
                   title="${message("shop.mainSidebar.productFavoriteListTitle")}" data-toggle="tooltip"
                   data-placement="left">
        ...
        <a id="mainSidebarBackTop" class="back-top" href="javascript:;"
           title="${message("shop.mainSidebar.backTopTitle")}">
