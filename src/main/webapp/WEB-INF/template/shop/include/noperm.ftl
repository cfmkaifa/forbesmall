			...
			<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="myModals">
					<div class="modal-header">
					 ...
					 <div class="modalBody">
						<form>
							<a id="supplierPay" class="btna btn-defaulta male" href="">${message("shop.article.supplier")}</a>
							<a id="purchaserPay" class="btna btn-defaulta male" href="">${message("shop.article.purchaser")}</a>
						</form>
					 </div>
				</div>
			</div>
