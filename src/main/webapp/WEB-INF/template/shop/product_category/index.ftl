                ...
                [#list rootProductCategories as rootProductCategory]
                    <div id="productCategory_${rootProductCategory_index}" class="panel panel-default">
                        <div class="panel-heading">
                            <h5>
                                <a class="text-red" href="${base}${rootProductCategory.path}"
                                   target="_blank">${rootProductCategory.name}</a>
                            </h5>
                        </div>
                                ...
                                <div class="child-category">
                                    [#list rootProductCategory.children as productCategory]
                                        <dl class="dl-horizontal clearfix">
                                            <dt>
                                                <a class="text-red-light" href="${base}${productCategory.path}"
                                                   target="_blank">
                                                            ...
                                                            [#list productCategories as productCategory]
                                                                <li>
                                                                    <a href="${base}${productCategory.path}"
                                                                       target="_blank">${productCategory.name}</a>
                                                                </li>
                                                            [/#list]
                                                        </ul>
                                                    </dd>
