...
<head>
	...
	<title>${message("business.mainSidebar.groupPurchApplyLogList")}  </title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("business.mainSidebar.groupPurchApplyLogList")}</li>
			</ol>
			<form action="${base}/business/group_purch_apply_log/list" method="get">
						...
						<div class="table-responsive">
							<table class="table table-hover">
								<thead>
									<tr>
										<th>
											<a href="javascript:;" data-order-property="memberName">
												${message("GroupPurchApply.memberName")}
										...
										<th>
											<a href="javascript:;" data-order-property="remarks">
												${message("GroupPurchApply.remarks")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
									</tr>
