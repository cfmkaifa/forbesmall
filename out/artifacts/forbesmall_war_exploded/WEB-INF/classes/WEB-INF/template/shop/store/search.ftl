                                        ...
                                        <div class="col-xs-6">
                                            <div class="media">
                                                <div class="media-left media-middle">
                                                    <a href="${base}${store.path}" title="${store.name}"
                                                       target="_blank">
                                                        <img class="img-responsive center-block"
                                                             src="${store.logo!setting.defaultStoreLogo}"
                                                             alt="${store.name}">
                                                    </a>
                                                </div>
                                                <div class="media-body media-middle">
                                                    ...
                                                    [#if store.introduction?has_content]
                                                        <p class="text-overflow"
                                                           title="${store.introduction}">${message("shop.store.introduction")}
