        ...
        [#escape x as x?js_string]
            <script>
                $().ready(function () {
                    ...
                    // 验证码图片
                    $passwordForm.on("error.mall.ajaxSubmit", function () {
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 control-label item-required"
                               for="newPassword">${message("shop.password.newPassword")}:</label>
                        <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 control-label item-required"
                               for="rePassword">${message("shop.password.rePassword")}:</label>
                        <div class="col-xs-6">
                            <input id="rePassword" name="rePassword" class="form-control" type="password" maxlength="20"
                                   autocomplete="off">
                        </div>
                    </div>
