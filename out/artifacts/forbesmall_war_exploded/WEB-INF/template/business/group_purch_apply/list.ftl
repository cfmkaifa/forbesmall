...
<head>
	...
	<title>${message("business.mainSidebar.groupPurchApplyList")}  </title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("business.mainSidebar.groupPurchApplyList")}</li>
			</ol>
			<form action="${base}/business/group_purch_apply/list" method="get">
