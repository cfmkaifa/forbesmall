            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label item-required" for="name">${message("Role.name")}
                            :</label>
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label" for="description">${message("Role.description")}
                            :</label>
                        <div class="col-xs-9 col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label">
                            <a class="role-group" href="javascript:;" title="${message("admin.role.roleGroupTitle")}"
                               data-toggle="tooltip">${message("admin.role.storeGroup")}:</a>
                        </label>
                        <div class="col-xs-9 col-sm-10 permissions">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="storeCategory" name="permissions" type="checkbox"
                                       value="admin:storeCategory">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="businessAttribute" name="permissions" type="checkbox"
                                       value="admin:businessAttribute">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="categoryApplication" name="permissions" type="checkbox"
                                       value="admin:categoryApplication">
                                <label for="categoryApplication">${message("admin.role.categoryApplication")}</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input id="businessDeposit" name="permissions" type="checkbox"
                                       value="admin:businessDeposit">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label">
                            <a class="role-group" href="javascript:;" title="${message("admin.role.roleGroupTitle")}"
                               data-toggle="tooltip">${message("admin.role.productGroup")}:</a>
                        </label>
                        <div class="col-xs-9 col-sm-10 permissions">
                            <div class="checkbox checkbox-inline">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="productCategory" name="permissions" type="checkbox"
                                       value="admin:productCategory">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="specification" name="permissions" type="checkbox"
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label">
                            <a class="role-group" href="javascript:;" title="${message("admin.role.roleGroupTitle")}"
                               data-toggle="tooltip">${message("admin.role.orderGroup")}:</a>
                        </label>
                        <div class="col-xs-9 col-sm-10 permissions">
                            <div class="checkbox checkbox-inline">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="orderShipping" name="permissions" type="checkbox"
                                       value="admin:orderShipping">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="deliveryCenter" name="permissions" type="checkbox"
                                       value="admin:deliveryCenter">
                                <label for="deliveryCenter">${message("admin.role.deliveryCenter")}</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input id="deliveryTemplate" name="permissions" type="checkbox"
                                       value="admin:deliveryTemplate">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label">
                            <a class="role-group" href="javascript:;" title="${message("admin.role.roleGroupTitle")}"
                               data-toggle="tooltip">${message("admin.role.memberGroup")}:</a>
                        </label>
                        <div class="col-xs-9 col-sm-10 permissions">
                            <div class="checkbox checkbox-inline">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="memberAttribute" name="permissions" type="checkbox"
                                       value="admin:memberAttribute">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="memberDeposit" name="permissions" type="checkbox"
                                       value="admin:memberDeposit">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="messageConfig" name="permissions" type="checkbox"
                                       value="admin:messageConfig">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label">
                            <a class="role-group" href="javascript:;" title="${message("admin.role.roleGroupTitle")}"
                               data-toggle="tooltip">${message("admin.role.distributorGroup")}:</a>
                        </label>
                        <div class="col-xs-9 col-sm-10 permissions">
                            <div class="checkbox checkbox-inline">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="distributionCash" name="permissions" type="checkbox"
                                       value="admin:distributionCash">
                                <label for="distributionCash">${message("admin.role.distributionCash")}</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input id="distributionCommission" name="permissions" type="checkbox"
                                       value="admin:distributionCommission">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label">
                            <a class="role-group" href="javascript:;" title="${message("admin.role.roleGroupTitle")}"
                               data-toggle="tooltip">${message("admin.role.contentGroup")}:</a>
                        </label>
                        <div class="col-xs-9 col-sm-10 permissions">
                            <div class="checkbox checkbox-inline">
                                <input id="navigationGroup" name="permissions" type="checkbox"
                                       value="admin:navigationGroup">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="articleCategory" name="permissions" type="checkbox"
                                       value="admin:articleCategory">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label">
                            <a class="role-group" href="javascript:;" title="${message("admin.role.roleGroupTitle")}"
                               data-toggle="tooltip">${message("admin.role.marketingGroup")}:</a>
                        </label>
                        <div class="col-xs-9 col-sm-10 permissions">
                            <div class="checkbox checkbox-inline">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label">
                            <a class="role-group" href="javascript:;" title="${message("admin.role.roleGroupTitle")}"
                               data-toggle="tooltip">${message("admin.role.systemGroup")}:</a>
                        </label>
                        <div class="col-xs-9 col-sm-10 permissions">
                            <div class="checkbox checkbox-inline">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="paymentMethod" name="permissions" type="checkbox"
                                       value="admin:paymentMethod">
                                <label for="paymentMethod">${message("admin.role.paymentMethod")}</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input id="shippingMethod" name="permissions" type="checkbox"
                                       value="admin:shippingMethod">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="paymentPlugin" name="permissions" type="checkbox"
                                       value="admin:paymentPlugin">
                                <label for="paymentPlugin">${message("admin.role.paymentPlugin")}</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input id="storagePlugin" name="permissions" type="checkbox"
                                       value="admin:storagePlugin">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input id="promotionPlugin" name="permissions" type="checkbox"
                                       value="admin:promotionPlugin">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label">
                            <a class="role-group" href="javascript:;" title="${message("admin.role.roleGroupTitle")}"
                               data-toggle="tooltip">${message("admin.role.statisticGroup")}:</a>
                        </label>
                        <div class="col-xs-9 col-sm-10 permissions">
                            <div class="checkbox checkbox-inline">
                                <input id="orderStatistic" name="permissions" type="checkbox"
                                       value="admin:orderStatistic">
                                <label for="orderStatistic">${message("admin.role.orderStatistic")}</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input id="fundStatistic" name="permissions" type="checkbox"
                                       value="admin:fundStatistic">
                                <label for="fundStatistic">${message("admin.role.fundStatistic")}</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input id="registerStatistic" name="permissions" type="checkbox"
                                       value="admin:registerStatistic">
                                <label for="registerStatistic">${message("admin.role.registerStatistic")}</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input id="productRanking" name="permissions" type="checkbox"
                                       value="admin:productRanking">
                    ...
                    <div class="row">
                        <div class="col-xs-9 col-sm-10 col-xs-offset-3 col-sm-offset-2">
                            ...
                            <button class="btn btn-default" type="button"
                                    data-action="back">${message("common.back")}</button>
                        </div>
                    </div>
                </div>
            </div>
