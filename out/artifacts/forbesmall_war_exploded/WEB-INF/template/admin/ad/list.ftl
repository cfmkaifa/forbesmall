                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-xs-12 col-sm-9">
                            <div class="btn-group">
                                <a class="btn btn-default" href="${base}/admin/ad/add"
                                   data-redirect-url="${base}/admin/ad/list">
                        ...
                        <div class="col-xs-12 col-sm-3">
                            <div id="search" class="input-group">
                                <div class="input-group-btn">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li[#if !page.searchProperty?? || page.searchProperty == "title"] class="active"[/#if]
                                                data-search-property="title">
                            ...
                            [#if page.content?has_content]
                                ...
                                [#list page.content as ad]
                                    <tr>
                                        ...
                                        <td>
                                            [#if ad.beginDate??]
                                                <span title="${ad.beginDate?string("yyyy-MM-dd HH:mm:ss")}"
                                                      data-toggle="tooltip">${ad.beginDate}</span>
                                            [#else]
                                                -
                                            [/#if]
                                        </td>
                                        <td>
                                            [#if ad.endDate??]
                                                <span title="${ad.endDate?string("yyyy-MM-dd HH:mm:ss")}"
                                                      data-toggle="tooltip">${ad.endDate}</span>
                                            [#else]
                                                -
                                            [/#if]
                                        </td>
                                        ...
                                        <td>
                                            <a class="btn btn-default btn-xs btn-icon"
                                               href="${base}/admin/ad/edit?id=${ad.id}"
