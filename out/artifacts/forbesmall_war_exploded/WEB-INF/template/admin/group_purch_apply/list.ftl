...
<head>
	...
	<title>${message("admin.groupPurchApply.list")}  </title>
				...
				$review.click(function() {
					...
					bootbox.prompt({
						...
						callback: function(result) {
							...
							$.ajax({
								url: "${base}/admin/group_purch_apply/review",
								type: "POST",
								data: {
									id: $element.data("id"),
									status: result
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.groupPurchApply.list")}</li>
			</ol>
			<form action="${base}/admin/group_purch_apply/list" method="get">
						...
						<div class="table-responsive">
							<table class="table table-hover">
								<thead>
									<tr>
										<th>
											<a href="javascript:;" data-order-property="storeName">
										...
										<th>
											<a href="javascript:;" data-order-property="groupPrice">
												${message("GroupPurchApply.groupPrice")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="mqqWeight">
												${message("GroupPurchApply.mqqWeight")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="limitWeight">
												${message("GroupPurchApply.limitWeight")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="mqqPeople">
												${message("GroupPurchApply.mqqPeople")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="limitPeople">
												${message("GroupPurchApply.limitPeople")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
									...
									<tbody>
										[#list page.content as groupPurchApply]
											<tr>
												...
												<td>${groupPurchApply.groupPrice}</td>
												<td>${groupPurchApply.mqqWeight}</td>
												<td>${groupPurchApply.limitWeight}</td>
												<td>${groupPurchApply.mqqPeople}</td>
												<td>${groupPurchApply.limitPeople}</td>
												...
												<td>
													[#if groupPurchApply.status == "PENDING"]
														<a class="review btn btn-default btn-xs btn-icon" href="javascript:;" title="${message("common.review")}" data-toggle="tooltip" data-id="${groupPurchApply.id}">
